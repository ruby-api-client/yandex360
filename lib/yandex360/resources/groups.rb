...
module Yandex360
  class GroupsResource < Resource
    ...
    def add_user(org_id:, group_id:, user_id:, type: "user")
      validate_required_params({org_id: org_id, group_id: group_id, user_id: user_id}, [:org_id, :group_id, :user_id])
      user = {
        id: user_id,
        type: type
      }
    ...
    def update(org_id:, group_id:, **user_params)
      validate_required_params({org_id: org_id, group_id: group_id}, [:org_id, :group_id])
    ...
    def create(org_id:, name:, **group_params)
      validate_required_params({org_id: org_id, name: name}, [:org_id, :name])
    ...
    def delete_user(org_id:, group_id:, type:, user_id:)
      validate_required_params({org_id: org_id, group_id: group_id, type: type, user_id: user_id}, [:org_id, :group_id, :type, :user_id])
